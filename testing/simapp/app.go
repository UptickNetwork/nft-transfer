// Package simapp is ibc-go v10.5.0 testing/simapp plus cosmos x/nft and ICS-721.
package simapp
...
import (
	...
	nftmock "github.com/bianjieai/nft-transfer/testing/mock"
...
var (
	...
	maccPerms = map[string][]string{
		...
		nft.ModuleName:                 nil,
		nfttransfertypes.ModuleName:    {authtypes.Minter, authtypes.Burner},
	}
)
...
func NewSimApp(
	...
	nftmock.RegisterImplementations(interfaceRegistry)
	...
	keys := storetypes.NewKVStoreKeys(
		...
		nft.StoreKey, nfttransfertypes.StoreKey,
	)
	...
	*/
	...
	app.NFTTransferKeeper = nfttransferkeeper.NewKeeper(
		...
		app.IBCKeeper.ChannelKeeper,
		app.AccountKeeper,
		nftmock.Wrap(appCodec, app.NFTKeeper),
	)
	...
	// ibc-go v10 keys the v1 router by port ID and requires an alphanumeric
	// identifier, so PortID equals ModuleName (not the ICS-721 spec string
	// "nft-transfer", which contains a hyphen).
	ibcRouter.AddRoute(nfttransfertypes.PortID, nftTransferIBCModule)
	...
	genesisModuleOrder := []string{
		...
		nft.ModuleName, nfttransfertypes.ModuleName,
